...
const SendCards = (props) => {
  ...
  const handleEdit = () => {
    if (user.edit1) {
      ...
      const associateprint = associate.associateData.find(
        (data) => data.associateName == edit.editData.receiverName
      );
      setSearchText(associateprint);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Dialog open={showPreview} fullWidth maxWidth="lg">
          <DialogContent
            style={{
      ...
      <Box id="previewScreenShot" ref={hiddenDataContentRef} style={{display:'none'}}>
        ...
        >
          <div dangerouslySetInnerHTML={{ __html: editorHtml }} />
          <div style={{position:"relative",top:"332px",display:"flex",flexWrap:"wrap",gap:"10px",justifyContent:""}}>
